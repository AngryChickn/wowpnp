class NpcsController < ApplicationController
  ...
  private
    ...
    def npc_params
      params.require(:npc).permit(:name, :level, :hitpoints, :stamina, :mana, :armor, :resistence, :strength, :agility, :intellect, :cunning, :willpower, :presence, :race_id, :klass_id, :notice)
    end
end
